...
public class PhoneLineSample extends javax.swing.JFrame {
    ...
    public PhoneLineSample() {
        ...
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Ready, new Transition[] { _ready_validNumberTransition, _ready_onHookTransition, _ready_invalidNumberTransition });
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Conversation, new Transition[] { _conversation_validNumberTransition, _conversation_invalidNumberTransition, _conversation_onHookTransition });
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Warning, new Transition[] { _warning_validNumberTransition, _warning_invalidNumberTransition, _warning_onHookTransition });
